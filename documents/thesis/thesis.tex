...
\begin{figure}[h]
    \begin{center}
        ...
        \caption{
            ...
            \textcite{dayan_theoretical_2001}. This graph closely resembles 
...
This spike had an amplitude of \SI{119.93}{\milli\volt} from baseline. 
The baseline was estimated to \SI{-54.63}{\milli\volt} and the
peak at \SI{53.30}{\milli\volt}. 
...
from pyramidal neurons often has a peak at \SI{20}{\milli\volt},
and that this was achived by scaling the original signal from the
Connor-Stevens model.
To compensate for the difference the action potental used in this 
simulation was 
normalized to \SI{83}{\milli\volt} (\cref{fig:3_1_soma_mem}).
\\

\begin{figure}[h]
\centering
\includegraphics[width=1\textwidth]{images/4_1/soma_mem.pdf}
...
\begin{figure}[thp]
\centering
\includegraphics[width=\textwidth]{images/4_1/soma_mem_fourier.pdf}
...
\begin{figure}[thp]
\centering
\includegraphics[width=\textwidth]{images/4_1/circular_spike_width_std.pdf}
...
% The amplitude in fourier analysis is proportional to the number of samples.
