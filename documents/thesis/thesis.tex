...
three classes of neurons were selected from from the blue brain models.
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=1\textwidth]{images/4_2/TTPC2_NBC_LBC_width_I.pdf}
        \caption{
            Nothing.
        }
        \label{fig:4_2_width_I}
    \end{center}
    \begin{center}
        \includegraphics[width=1\textwidth]{images/4_2/TTPC2_NBC_LBC_width_II.pdf}
        \caption{
            Nothing.
        }
        \label{fig:4_2_width_II}
    \end{center}
\end{figure}

A further distinguishment can be seen using the coefficient of variation of
the two width definitions (the relative value of standard deviation and mean)
\cref{fig:4_2_width_snr}.

\begin{figure}[h]
    \begin{center}
        \includegraphics[width=1\textwidth]{images/4_2/TTPC2_NBC_LBC_snr.pdf}
        \caption{
            Nothing.
        }
