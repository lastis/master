...
are electrically excitiable brain cells capable of transmitting 
electrical signals across their structures.
...
While neurons often has many dendrites directly attached to the soma
...
Other junction include but are not limited to,
...
the action potential \emph{regenrative}, meaning it will propagate
without decaying as a passive signal. 
