...
\begin{figure}[h]
\centering
\includegraphics[angle=-90,width=\textwidth]{images/2_1/neuron_structure.pdf}
...
\gls{glos:activechannels} where the active can change the
...
To verify that the simulation environment can be trusted it was attempted to reproduce
some results from 
\textcite{pettersen_amplitude_2008}.
Spesifically the spike width and amplitude dependency in relation to distance from soma 
should be the same. 
\\
