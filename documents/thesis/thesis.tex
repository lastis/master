...
which creates many challanges for new users as hoc is no longer
maintained by its developers and questions and bugs in Neuron
modern standard.
...
With Neuron there is no inherent support for 
running simulations simultaniously and 
this is also lacking in LFPy. 
LFPyUtil attempts to solve this by starting each simulation
in an independent processes. 
...
simulation. 
With independent processes this is no longer a problem.
