...
% The width definitionse were analysed
% using ROC curves. 
...
The width of an action potential depends on the definition and there
...
Of some spike width definitions encountered were:
...
SphereRand (\cref{sec:simulation_list}) simulation class.
\newline
