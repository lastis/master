...
Of X models ran only 10 are pyramidal neurons.
The number of available models were based on the diversity of the 
morphology and the electrophysiological repsonse of the neurons. 
Because only 2 m-types and 1 e-type were identified for pyramidal
neurons this resulted in 10 avaiable neuron models.
Neurons were classified into m-types and e-types depending on the morphology
and the spike pattern.
In total there was identified 11 e-types of which 10 was 
inhibitory e-types and 1 was excitatory. 
For each me-type the blue brain team created 5 models which are 
publically available.
For pyramidal neurons in L5 there was found 2 m-types and 1 e-type,
this gave a result of 2 me-types and thusly only 10 pyramidal 
models are available.
In the case of interneurons the diversity was much bigger. 
...
\textcite{pettersen_amplitude_2008}
which was \SI{0.55}{\milli\second} and must have been rounded to
