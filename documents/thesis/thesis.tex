...
9 m-types and 10 e-types which gave a total number
...
\begin{align}
    c_v = \frac{\sigma}{\mu}
\end{align}
In many cases the lower $c_v$ value will be more robust to noise.
...
\begin{figure}[h]
    ...
    \end{center}
\end{figure}
The two amplitude definitions investigated here are
