...
\verb+plot()+.
The LFPyUtil simulation class has other properties that 
among other things enable saving and loading data and 
naming those files. 
Because of this a new custom simulation class should inherit
LFPyUtil's simulation class. 

\Cref{code:new_simulation_class} 
inherits the LFPyUtil simulation class and
defines functions that can insert a stimulus electrode 
and apply a current.
