...
possible to apply the AUC seperation metric because
the classification cannot be based on a single threshold. 
To compare the 2d histogram of spike amplitude and width the 
intersection divided by the union of the two histograms were compared. 

Some neurons can be placed in certain areas of amplitude width space.
