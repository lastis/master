...
simulations were 
scaled to \SI{83}{\milli\volt} (\cref{fig:4_1_cs_ap_norm}).
\\

\begin{figure}[h]
    \begin{center}
        \includegraphics[width=1\textwidth]{images/4_1/cs_ap_norm.pdf}
        \caption{
...
time resolution 
$dt = \SI[exponent-base=2]{e-6}{\milli\second}$. 
