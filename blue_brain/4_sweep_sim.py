...
dir_output = os.path.join(dir_current, "4_sweep_sim")
...
def get_simulator(neuron_name):
    ...
    if 'L5_TTPC2_cADpyr232_1' in neuron_name:
        sim_sweep.run_param['amp_start'] = 0.207
        sim_sweep.run_param['amp_end'] = 0.989
